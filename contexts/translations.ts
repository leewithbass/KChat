...
export const translations = {
  en: {
    ...
    sendWithCmdEnter: 'Send with Cmd+Enter',
    sendWithCmdEnterDesc: 'Use Cmd+Enter (Mac) or Ctrl+Enter (Windows/Linux) to send messages instead of Enter.',
  ...
  zh: {
    ...
    sendWithCmdEnter: '使用 Cmd+Enter 发送',
    sendWithCmdEnterDesc: '使用 Cmd+Enter (Mac) 或 Ctrl+Enter (Windows/Linux) 发送消息，而不是 Enter。',
    dataManagement: '数据管理',
    importData: '导入数据',
